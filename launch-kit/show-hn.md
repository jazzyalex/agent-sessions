...
- `Show HN: Agent Sessions – one local view of Codex, Claude, Cursor and 6 more`
- `Show HN: Search your local coding-agent history across 9 tools (macOS, no cloud)`
