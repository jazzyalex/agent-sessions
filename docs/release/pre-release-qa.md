...
- [ ] Sparkle and GitHub release notes previews are reviewed as user-facing product copy: lead with the release headline, omit internal implementation cleanup, and avoid presenting pre-release stabilization as a shipped bug fix.
