...
- Docs/Website: Repositioned Agent Sessions around local history for CLI tools, desktop apps, and app-bundled agents, with new SEO guides for Codex rollout history, Cursor Agent transcripts, Hermes `state.db` sessions, and OpenClaw JSONL history.
