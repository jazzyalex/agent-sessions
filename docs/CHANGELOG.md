...
### Highlights
- **Devin CLI and fx join the lineup.** Fifteen coding agents now put their local history in one searchable list, with a Settings pane and a resume command each.
