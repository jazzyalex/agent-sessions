...
| `plans/2026-06-30-transcript-phase4-find-jump.md` | **PARKED (2026-07-03):** under-threshold sessions get whole-session Find for free post-swap; the window-paging machinery only serves the monster tier. Additionally, the transcript UI redesign (`docs/transcript-ui-redesign-proposal.md`) may change which view mode is default and what Find infra is worth building. Do not start before redesign Phase 1 decisions. |
