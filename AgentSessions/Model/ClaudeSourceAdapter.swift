...
// App-only half of the Claude source: runtime factory and palette. The UI-free
// descriptor lives in ClaudeSourceDescriptor.swift and is shared with the Linux core.
